...
class MainActivityTest {
    ...
    fun assertGetCircumference() {
        onView(withId(R.id.edt_length)).perform(typeText(dummyLength), closeSoftKeyboard()) // kalo dibaca : Sebuah view dengan id edt_length diberi tindakan input dengan sebuah teks dummyLength dan menutup secara berlahan keyboard Android.
        ...
        onView(withId(R.id.btn_save)).check(matches(isDisplayed())) // kalo di baca : Memastikan sebuah view dengan id btn_save dalam keadaan tampil.
        onView(withId(R.id.btn_save)).perform(click()) // kalo di baca : Sebuah view dengan id btn_save diberi aksi klik.
        ...
        onView(withId(R.id.tv_result)).check(matches(withText(dummyCircumference))) // kalo di baca : Memastikan sebuah view dengan id tv_result mempunyai teks yang sama dengan dummyCircumference
    }
    ...
    fun assertEmptyInput() {
        ...
        onView(withId(R.id.btn_save)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_save)).perform(click())
        onView(withId(R.id.edt_length)).check(matches(hasErrorText(fieldEmpty))) // kalo di baca :  Memastikan sebuah view dengan id edt_length mempunyai pesan eror yang sama dengan fieldEmpty
        onView(withId(R.id.edt_length)).perform(typeText(dummyLength), closeSoftKeyboard())
