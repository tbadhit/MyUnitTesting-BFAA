...
// Update "activity_main.xml"(1)
// Create new kotlin class "CuboidModel"
// Add code in "CubidModel" class (1)
// Create new kotlin class "MainViewModel"
// Add code in "MainViewModel" class (1)
// Add code in "MainActivty" (1) (2)

// Next we will try UnitTesting using Mockito
// Add dependecies in "build.gradle(module: app)" (1)
// Open MainViewModel then press CTRL + SHIFT + T or ALT + ENTER in MainViewModel
// Choose "Create test"
